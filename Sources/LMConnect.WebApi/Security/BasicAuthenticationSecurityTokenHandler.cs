...
namespace LMConnect.WebApi.Security
{
	public class BasicAuthenticationSecurityTokenHandler : UserNameSecurityTokenHandler
	{
		...
		public delegate LMConnect.Key.User ValidateUserNameCredentialDelegate(string username, string password);
		...
		/// <param name="password">The password.</param>
		/// <returns></returns>
		protected virtual LMConnect.Key.User ValidateUserNameCredentialCore(string userName, string password)
		{
			if (ValidateUserNameCredential == null)
			{
